...
import { ConsumeRewardSettingsSection } from '../general/consume-reward-settings-section'
...
const BILLING_SECTIONS = [
  ...
  {
    id: 'consume-reward',
    titleKey: 'Consecutive consumption rewards',
    build: (settings: BillingSettings) => (
      <ConsumeRewardSettingsSection
        defaultValues={{
          enabled: settings['consume_reward_setting.enabled'],
          dailyQuota: settings['consume_reward_setting.daily_quota'],
          rewardQuota: settings['consume_reward_setting.reward_quota'],
          consecutiveDays: settings['consume_reward_setting.consecutive_days'],
        }}
      />
    ),
  },
