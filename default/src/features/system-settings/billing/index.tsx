...
const defaultBillingSettings: BillingSettings = {
  ...
  'consume_reward_setting.enabled': false,
  'consume_reward_setting.daily_quota': 0,
  'consume_reward_setting.reward_quota': 0,
  'consume_reward_setting.consecutive_days': 7,
}
