...
export type BillingSettings = {
  ...
  'consume_reward_setting.enabled': boolean
  'consume_reward_setting.daily_quota': number
  'consume_reward_setting.reward_quota': number
  'consume_reward_setting.consecutive_days': number
}
